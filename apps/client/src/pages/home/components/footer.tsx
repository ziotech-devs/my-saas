    ...
    <div className="container grid py-12 sm:grid-cols-3 lg:grid-cols-4">
      ...
      <div className="space-y-4">
        ...
        <div className="flex flex-col gap-y-2">
          ...
          <Link to="/meta/privacy-policy" className="text-sm text-muted-foreground hover:text-foreground">
            {t`Privacy Policy`}
          </Link>
          <Link to="/meta/terms" className="text-sm text-muted-foreground hover:text-foreground">
            {t`Terms of Service`}
          </Link>
        </div>
      </div>
