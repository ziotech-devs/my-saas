...
export class StorageService implements OnModuleInit {
  ...
  async onModuleInit() {
    ...
    if (skipBucketCheck) {
      ...
      this.logger.warn(
        "Make sure that the following paths are publicly accessible: `/{pictures,previews,documents}/*`",
      );
  ...
  async uploadObject(
    ...
    const extension = type === "documents" ? "pdf" : "jpg";
