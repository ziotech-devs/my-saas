...
export class NetworkStack extends Stack {
  ...
  public readonly graphsRdsSecurityGroup: SecurityGroup;
  ...
  constructor(scope: Construct, id: string, props?: NetworkStackProps) {
    ...
    this.graphsRdsSecurityGroup = new SecurityGroup(this, 'GraphsRdsSecurityGroup', {
      vpc: this.vpc,
      securityGroupName: 'my-saas-graphs-rds-sg',
      description: 'Security group for LangGraph RDS PostgreSQL',
      allowAllOutbound: false,
    });

    this.graphsRdsSecurityGroup.addIngressRule(
      this.graphsSecurityGroup,
      Port.tcp(5432),
      'Allow PostgreSQL from Graphs service'
    );

    this.redisSecurityGroup = new SecurityGroup(this, 'RedisSecurityGroup', {
      vpc: this.vpc,
      securityGroupName: 'my-saas-redis-sg',
    ...
    this.redisSecurityGroup.addIngressRule(
      this.graphsSecurityGroup,
      Port.tcp(6379),
      'Allow Redis from Graphs service'
    );
  }
}
